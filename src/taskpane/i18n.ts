export const en = {
  ...
  scan: 'Scan Workbook', show: 'Show Images', refresh: 'Refresh Images', remove: 'Remove Preview Images', repairDamagedImages: 'Repair metadata code cells', repairComplete: '{detected} code cells found · {restored} images restored · {cleared} code cells cleared.', viewImages: 'View large images',
...
export const zhCN: Record<MessageKey, string> = {
  ...
  scan: '扫描工作簿', show: '显示图片', refresh: '刷新图片', remove: '移除预览图片', repairDamagedImages: '修复显示为代码的图片单元格', repairComplete: '检测到 {detected} 个代码单元格 · 已恢复 {restored} 张图片 · 已清除 {cleared} 个代码单元格。', viewImages: '查看大图',
