export const en = {
  ...
  worksheetImageSelected: 'Image selected. You can enlarge it in the worksheet.', imageSummary: '{found} images ready · {unresolved} need attention',
...
export const zhCN: Record<MessageKey, string> = {
  ...
  worksheetImageSelected: '已选中图片，现在可直接在工作表中放大。', imageSummary: '可显示 {found} 张 · 需处理 {unresolved} 张',
