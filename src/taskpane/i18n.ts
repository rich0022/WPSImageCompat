export const en = {
  ...
  language: 'Language', auto: 'Follow Excel', detected: 'Detected:', images: 'WPS images', excelImages: 'Excel image shapes', excelEmbeddedImages: 'Excel floating pictures',
...
export const zhCN: Record<MessageKey, string> = {
  ...
  language: '语言', auto: '跟随 Excel', detected: '已检测：', images: '张 WPS 图片', excelImages: '张 Excel 图片', excelEmbeddedImages: '张 Excel 浮动嵌入图片',
