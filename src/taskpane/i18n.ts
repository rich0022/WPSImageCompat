export const en = {
  ...
  badge: 'Compatibility & images', intro: 'An Excel compatibility toolbox for WPS images, embedded pictures, and workbook checks.',
  language: 'Language', auto: 'Follow Excel', detected: 'Detected:', images: 'WPS images', excelImages: 'Excel image shapes', excelEmbeddedImages: 'Excel embedded images',
  ...
  scan: 'Scan Workbook', inspectExcelImages: 'Inspect Excel embedded pictures', excelPictureInventory: 'Excel picture inventory complete: {images} embedded images.', excelEmbeddedSummary: 'Excel embedded images: {images} across {sheets} worksheets.', show: 'Show Images', refresh: 'Refresh Images', remove: 'Remove Preview Images', repairDamagedImages: 'Repair metadata code cells', repairSelectedImage: 'Repair selected code cell', repairSelectedEmpty: 'The selected cell has no recoverable WPS Image Compat code.', repairComplete: '{detected} code cells found · {restored} images restored · {cleared} code cells cleared.', viewImages: 'View large images',
  ...
  imageToolsTitle: 'Image recovery toolbox', moreToolsTitle: 'Reports and support', zoomSelectedImage: 'Enlarge selected image', restoreSelectedImage: 'Restore selected image',
  worksheetImagePreview: 'preview', worksheetImageConverted: 'converted', worksheetImagesReady: 'Choose an image below to enlarge it in the worksheet.', worksheetImagesEmpty: 'No WPS Image Compat pictures were found in this workbook.', worksheetImageZoomed: 'The image is enlarged in the worksheet. Activate it again to restore it to its cell.', worksheetImageRestored: 'The image was restored to its cell-sized position.',
  worksheetImageSelected: 'Plugin image selected. Use the task pane to change its size.', worksheetImageAutoToggle: 'Automatically enlarge or restore a selected plugin image in the worksheet', imageSummary: '{found} images ready · {unresolved} need attention', excelImageSummary: 'Excel image shapes: {images} across {sheets} worksheets',
...
export const zhCN: Record<MessageKey, string> = {
  ...
  badge: '兼容检查与图片预览', intro: '用于 WPS 图片、Excel 内嵌图片和工作簿检查的 Excel 兼容工具箱。',
  language: '语言', auto: '跟随 Excel', detected: '已检测：', images: '张 WPS 图片', excelImages: '张 Excel 图片', excelEmbeddedImages: '张 Excel 内嵌图片',
  ...
  scan: '扫描工作簿', inspectExcelImages: '检查 Excel 内嵌图片', excelPictureInventory: 'Excel 图片盘点完成：发现 {images} 张内嵌图片。', excelEmbeddedSummary: 'Excel 内嵌图片：{images} 张，分布在 {sheets} 个工作表。', show: '显示图片', refresh: '刷新图片', remove: '移除预览图片', repairDamagedImages: '修复显示为代码的图片单元格', repairSelectedImage: '修复所选代码单元格', repairSelectedEmpty: '当前选中单元格没有可恢复的 WPS Image Compat 代码。', repairComplete: '检测到 {detected} 个代码单元格 · 已恢复 {restored} 张图片 · 已清除 {cleared} 个代码单元格。', viewImages: '查看大图',
  ...
  imageToolsTitle: '图片恢复工具箱', moreToolsTitle: '报告与支持', zoomSelectedImage: '放大已选图片', restoreSelectedImage: '缩小已选图片',
  worksheetImagePreview: '预览图片', worksheetImageConverted: '已转换图片', worksheetImagesReady: '请在下方选择图片，直接在工作表中放大。', worksheetImagesEmpty: '当前工作簿没有找到 WPS Image Compat 图片。', worksheetImageZoomed: '图片已在工作表中放大；再次选中图片可还原到单元格。', worksheetImageRestored: '图片已还原到单元格大小和位置。',
  worksheetImageSelected: '已选中插件图片，可在右侧窗格调整大小。', worksheetImageAutoToggle: '选中工作表中的插件图片时，自动放大或还原', imageSummary: '可显示 {found} 张 · 需处理 {unresolved} 张', excelImageSummary: 'Excel 图片：{images} 张，分布在 {sheets} 个工作表',
