export const en = {
  ...
  imageToolsTitle: 'Restore WPS images', moreToolsTitle: 'Reports and support', zoomSelectedImage: 'Enlarge selected image', restoreSelectedImage: 'Restore selected image',
...
export const zhCN: Record<MessageKey, string> = {
  ...
  scan: '扫描工作簿', show: '显示图片', refresh: '刷新图片', remove: '移除预览图片', repairDamagedImages: '修复显示为代码的图片单元格', repairSelectedImage: '修复所选代码单元格', repairSelectedEmpty: '当前选中单元格没有可恢复的 WPS Image Compat 代码。', repairComplete: '检测到 {detected} 个代码单元格 · 已恢复 {restored} 张图片 · 已清除 {cleared} 个代码单元格。', viewImages: '查看大图',
  ...
  imageToolsTitle: '恢复 WPS 图片', moreToolsTitle: '报告与支持', zoomSelectedImage: '放大已选图片', restoreSelectedImage: '缩小已选图片',
